...
*/}}
{{- define "release-operator.fullname" -}}
...
*/}}
{{- define "release-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "release-operator.resourceName" -}}
{{- $fullname := include "release-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "release-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
