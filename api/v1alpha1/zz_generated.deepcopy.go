...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReleaseBindings) DeepCopyInto(out *ReleaseBindings) {
	*out = *in
	if in.Database != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReleaseBindings.
func (in *ReleaseBindings) DeepCopy() *ReleaseBindings {
	if in == nil {
		return nil
	}
	out := new(ReleaseBindings)
	in.DeepCopyInto(out)
	return out
}
